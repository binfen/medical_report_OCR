...
class SiameseNetwork:
    ...
    Attributes:
        ...
        chars_loader: instance of CharsLoader
    ...
    def __init__(self, dataset_path,  learning_rate, batch_size, use_augmentation,
        ...
        Arguments:
            dataset_path: path of OCR dataset
            learning_rate: SGD learning rate
            ...
            learning_rate_multipliers: learning-rate multipliers (relative to the learning_rate
                chosen) that will be applied to each for the conv and dense layers
                for example:
    ...
    def train_siamese_network(self, number_of_iterations, support_set_size,
        ...
        # First of all let's divide randomly the 8 train buckets in train
        # and validation with 7 for training and 1 for validation
        self.chars_loader.split_train_datasets()
        ...
        for iteration in range(number_of_iterations):
            ...
            # train set
            images, labels = self.chars_loader.get_train_batch()
